...
uint256 hashGenesisBlock("0x32dca787cfb73d50595a599b6fd72afce9a7c52ead22b8f15dfd8aabc5eaac32");
...
const string strMessageMagic = "prux Signed Message:\n";
...
{
    int64 nSubsidy = 0.009595 * COIN;

    // Subsidy is cut in half every 595950 blocks, which will occur approximately every 3/4 years
    nSubsidy >>= (nHeight / 5959595); // Peppsycoin: 595950 blocks in 3/4 years
...
else
{
    ...
    // prux: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal prux miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "prux", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc15a681392de961876d8013c7b81c1ec16d7cdb3e2802cebf4f95a6cc754c51a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1406496258; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2984499;

        if (fTestNet)
        {
            block.nTime    = 1406494157;
            block.nNonce   = 269004;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x275a35ac6f6d4a6f7a60ee3ca38a90fe98e43646b6535cf3f99f6b004a4016b6"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // prux: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
